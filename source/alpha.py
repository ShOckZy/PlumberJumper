...
#=================Imagenes====================================
bala = pygame.image.load("../assets/bala1.png")
fondo = pygame.image.load("../fondos/inicio.png")
burbuja = pygame.image.load("../personajes/enemigos/burbuja1.png")
#================================================================
#======================Enemigo===================================
def enemigo():
    global posX
...
def main():
    ...
    pygame.display.set_caption("Plumber Jumper Game")

    plomero = pygame.image.load("../personajes/principal/plomero.png")
